...
def make_predictions(input_df, input_dict):
  ...
  # Check if ut module is correctly imported
  try:
      with col1:
      ...
      st.error("Chart creation function not found. Ensure 'ut' module is imported correctly.")
...
def explain_prediction(probability, input_dict, surname):
  ...
  Do not mention the probability of churning, the machine learning model, or say anything like "Based on the machine learning model's prediction and top 10 most important features." Just explain the prediction.
  """
...
try:
    ...
    st.error("File 'churn.csv' not found. Please upload the correct file.")
    st.stop()
...
if selected_customer_option:
    ...
    with col1:
        ...
        tenure = st.number_input(
            "Tenure (years)", min_value=0, max_value=50, value=int(selected_customer['Tenure'])
        )
    ...
    with col2:
        ...
        num_products = st.number_input(
            "Number of Products", min_value=1, max_value=10, value=int(selected_customer['NumOfProducts'])
        )
        ...
        estimated_salary = st.number_input(
            "Estimated Salary", min_value=0.0, value=float(selected_customer['EstimatedSalary'])
        )
